;由于代码量的问题，本程序是由凌老师提供的实验一的程序上修改的得到的
%include "head.asm"
org offset_usrprog3
    ...
    os_left equ -1     ; 字符运动左边界
    os_top equ 11      ; 字符运动上边界
    os_right equ 40    ; 字符运动右边界
    os_bottom equ 25   ; 字符运动下边界
    pos_y equ 0      ; 起点列数
    pos_x equ 19      ; 起点行数
...
;    infolen dw $-myinfo    ; myinfo字符串的c长度
    curcolor db 80h        ; 保存当前字符颜色属性，用于myinfo
    curcolor2 db 01h       ; 保存当前字符颜色属性，用于移动的字符

    hint1 db 'User program c is running. Press ESC to exit.'
    hint1len equ ($-hint1)
