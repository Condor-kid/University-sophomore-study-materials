...
ld -m elf_i386 -N -Ttext 0x8000 --oformat binary ./temp/osstarter.o ./temp/myos.o ./temp/myos_c.o ./temp/hotwheel.o -o ./temp/myos_c.bin
rm ./temp/*.o
...
dd if=./temp/myos_c.bin of=Condor_OS.img bs=512 seek=2 count=16 2> /dev/null
